...
SECTIONS
{
    ...
    codestart            : >  0x080000
    .text                : >> FLASH_BANK0_SEC2 | FLASH_BANK0_SEC3 | FLASH_BANK0_SEC4 | FLASH_BANK0_SEC5 | FLASH_BANK0_SEC6 | FLASH_BANK0_SEC7 | FLASH_BANK0_SEC8 | FLASH_BANK0_SEC9,
                              ALIGN(8)
    .TI.ramfunc          :    LOAD >  FLASH_BANK0_SEC1,
                              RUN  >  RAMGS3,
                              TABLE(BINIT),
                              ALIGN(8)
    .binit               : >  FLASH_BANK0_SEC0,
                              ALIGN(8)
    ...
    .init_array          : >  FLASH_BANK0_SEC1,
                              ALIGN(8)
    .bss                 : >> RAMLS1 | RAMLS2 | RAMLS3 | RAMLS4 | RAMLS5 | RAMLS6
    ...
    // User Sections
    //
    FPUmathTables { *(FPUmathTables) }       LOAD >  FLASH_BANK0_SEC6,
                              RUN  >  RAMGS1,
                              TABLE(BINIT),
                              ALIGN(8)
    dclfuncs { *(dclfuncs) }       LOAD >  FLASH_BANK0_SEC7,
                              RUN  >  RAMGS2,
                              TABLE(BINIT),
                              ALIGN(8)
